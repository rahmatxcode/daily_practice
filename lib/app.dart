...
import 'package:daily_practice/state_concepts/stateful_life.dart';
    ...
    return ScreenUtilInit(
      ...
      builder: (_, child) {
        return MaterialApp(
          ...
          theme: AppTheme
              .lightTheme, // this is used to set the light theme of the app. it is a static property of the AppTheme class that contains the light theme of the app. it is passed as a parameter to the MaterialApp constructor.
          darkTheme:
              AppTheme.darkTheme, // this is used to set the dark theme of
          // theme: ThemeData(
          ...
          //home: ThemeTest(),
          initialRoute:
              'statefullife', // this is used to set the initial route of the app. it is a string that contains the name of the route. it is passed as a parameter to the MaterialApp constructor.
          routes: {
